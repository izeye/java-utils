...
class MapUtilsTests {
	...
	void testGetValueByPath() {
		...
		assertThat(MapUtils.getValueByPath(map, String.class, "full_name", "first_name")).isEqualTo("Johnny");
		assertThat(MapUtils.getValueByPath(map, String.class, "full_name", "last_name")).isEqualTo("Lim");
