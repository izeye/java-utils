...
class UrlUtilsTests {
	...
	void testPrependHttpProtocolIfAbsent() {
		assertThat(UrlUtils.prependHttpProtocolIfAbsent("www.google.com")).isEqualTo("http://www.google.com");
		assertThat(UrlUtils.prependHttpProtocolIfAbsent("http://www.google.com")).isEqualTo("http://www.google.com");
		assertThat(UrlUtils.prependHttpProtocolIfAbsent("https://www.google.com")).isEqualTo("https://www.google.com");
	}
