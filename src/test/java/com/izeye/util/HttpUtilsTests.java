...
public class HttpUtilsTests {
	...
	public void testParseQueryString() {
		...
		assertThat(HttpUtils.parseQueryString("a=1&b=")).hasSize(1).containsEntry("a",
				"1");
		assertThat(HttpUtils.parseQueryString("a=1&b=2&c=")).hasSize(2)
				.containsEntry("a", "1").containsEntry("b", "2");
		assertThat(HttpUtils.parseQueryString("a=1%3A2&b=2&c=")).hasSize(2)
				.containsEntry("a", "1:2").containsEntry("b", "2");
	}
